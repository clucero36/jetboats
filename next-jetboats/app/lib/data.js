...
const faqs = [
  {
    ...
    answer:
      'Currently the JBC T-Shirt comes in Black. We are currently working manufacturing more colors.',
  },
  {
    productId: data[0].id,
    question: 'Is the T-Shirt image prone to fading?',
    answer:
      "Yes. We reccomend washing the T-Shirt inside out with cold water.",
  },
  {
    productId: data[1].id,
    question: 'Will the Tank-Top be sold in smaller sizes?',
    answer:
      `No. The JBC Tank-Tops run small. We reccomend buying a lg if you're under 5"8, an xlg if you're under 6"0, and a 2xl otherwise.`,
  },
  {
    productId: data[2].id,
    question: 'Is the Earthen Bottle dishwasher safe?',
    answer:
      "Yes. The JBC Earthen Bottle is 100% dishwasher safe."
  },
  {
    productId: data[2].id,
    question: 'What is the Earthen Bottle made out of?',
    answer: 
      "The JBC Earthen Bottle is made from 100% recycled materials."
  },
  {
    productId: data[3].id,
    question: 'Is the Nomad Tumbler insulated?',
    answer: 
      "Yes, the JBC Nomad Tumbler is made to insulate both hot and cold bevereages"
  }
]
...
const reviews = [
  {
    productId: data[0].id,
    rating: 5,
    content: `I'm in love with my T-Shirt! Great Quality! GO JBC!`,
    date: 'July 16, 2021',
    datetime: '2021-07-16',
    author: 'Emily Selman',
    avatarSrc:
  ...
  },
  {
    productId: data[1].id,
    rating: 3,
    content: `The size runs a little small. Or maybe I'm just big. I love it nonetheless.`,
    date: 'July 12, 2021',
    datetime: '2021-07-12',
    author: 'Hector Gibbons',
    avatarSrc:
