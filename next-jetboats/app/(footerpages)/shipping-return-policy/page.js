    ...
    <div className='py-24 sm:py-32'>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900">Shipping & Return Policy</h2>
          ...
          <p className="mt-6 text-sm leading-8 text-gray-600"><em>This document was last updated on September 17, 2024.</em></p>
        </div>
      </div>
    </div>
  )
